...
let name = "Mariyah"
let number = "1,000,000,000,000"
let ADJ = "Cute"
let nounOne = "planet"
let nounTwo = "Burger King"
let PosEmo = "Happy"
let NegEmo = "Mad"
let nounThree = "Monster Toes"
let StoryTime = "Today was a big day for " + name + ". They had finally saved up " + number + " dollars and were going to buy a " + ADJ + nounOne + " . They went to the" + nounTwo + " feeling very " + PosEmo + ". But then they felt " + NegEmo + ". They were all out of " + nounThree + "!"
//:
//:
